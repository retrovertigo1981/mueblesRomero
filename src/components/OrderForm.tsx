...
export const OrderForm = () => {
	...
	const {
		...
		// 📊 DEBUG: Verificar tamaño (opcional, descomentar si necesitas)
		// if (productImageSrc && productImageSrc.startsWith('data:')) {
		//   const sizeInKB = Math.round(productImageSrc.length / 1024);
		//   console.log(`📊 Tamaño imagen base64: ${sizeInKB} KB`);
		//   if (sizeInKB > 190) {
		//     toast.error(`La imagen es demasiado grande: ${sizeInKB} KB (máximo 190 KB)`);
		//     return;
		//   }
		// }

		// Construir parámetros del email
		const templateParams: Record<string, unknown> = {
			...
			// 🔥 IMAGEN UNIFICADA - SIEMPRE CON SRC COMPLETO
			product_image: productImageSrc,

			// Flag para customización
...
// 		// 🎯 PROCESAR IMAGEN SEGÚN TIPO DE PRODUCTO
...
// 			// ========================================
// 			// CASO 2: PRODUCTO ESTÁNDAR (URL desde API)
// 			// ========================================
